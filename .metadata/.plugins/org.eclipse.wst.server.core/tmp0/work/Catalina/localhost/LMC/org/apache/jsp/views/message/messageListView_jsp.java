 ...
 * Generated at: 2023-10-24 04:47:00 UTC
...
public final class messageListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/message/../common/menubar.jsp", Long.valueOf(1698080520456L));
    _jspx_dependants.put("/views/message/../common/footer.jsp", Long.valueOf(1697763428000L));
  }
  ...
  static {
    ...
    _jspx_imports_classes.add("com.lmc.message.model.vo.Message");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
	...
	String status = (String)request.getAttribute("status"); // "recived" 또는 "sent"
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    .message-area select:hover {\r\n");
      out.write("        cursor: pointer;\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    .table>tbody>tr:hover{\r\n");
      out.write("        cursor: pointer;\r\n");
      out.write("        background-color: rgb(237, 237, 237);\r\n");
      out.write("    }\r\n");
      out.write("</style>\r\n");
      out.write("\r\n");
      out.write("<body>\r\n");
...
if(loginUser == null){ 
      ...
      out.write("\r\n");
      out.write("            <br>\r\n");
      out.write("            <h2 style=\"font-family: 'LINESeedKR-Bd'; float: left;\"><i class=\"far fa-envelope\"></i> 쪽지함</h2>  \r\n");
      out.write("            <br>             \r\n");
      out.write("\r\n");
      out.write("                <div class=\"message-area\">\r\n");
      out.write("				    <select name=\"ms-select\" id=\"ms-select\">\r\n");
      out.write("				        <option value=\"recived\">받은 쪽지</option>\r\n");
      out.write("				        <option value=\"sent\">보낸 쪽지</option>\r\n");
      out.write("				    </select>\r\n");
      out.write("				\r\n");
      out.write("				    <table class=\"table\" align=\"center\" style=\"border-spacing: 0px;\">\r\n");
      out.write("					    <thead>\r\n");
      out.write("					        <tr>\r\n");
      out.write("					           	<th width=\"60\" style=\"text-align:center;\">No.</th>\r\n");
      out.write("					            <th width=\"450\" style=\"text-align:center;\">내용</th>\r\n");
      out.write("					            <th width=\"120\" style=\"text-align:center;\" id=\"status\">보낸 사람</th>\r\n");
 ...
 for (Message m : list) { 
      ...
      out.write("</td>\r\n");
      out.write("					                    <td>");
      out.print( m.getDmContent() );
      out.write("</td>\r\n");
      out.write("					                    <td style=\"text-align:center;\">");
      out.print( m.getDmSendMember() );
      out.write("</td>\r\n");
      out.write("					                    <td style=\"text-align:center;\">");
      out.print( m.getDmSendDate() );
      out.write("</td>\r\n");
      out.write("					                </tr>\r\n");
      out.write("					            ");
 } 
      ...
      out.write("        	$(function() {\r\n");
      out.write("        		\r\n");
      out.write("        		$(\"#ms-select\").change(function() {\r\n");
      out.write("\r\n");
      out.write("					let status = $(\"#ms-select\").val();\r\n");
      out.write("					// alert(status);\r\n");
      out.write("        			\r\n");
      out.write("        			location.href = \"list.mes?status=\" + status;\r\n");
      out.write("        		});\r\n");
      out.write("        		\r\n");
      out.write("        	});\r\n");
      out.write("        	\r\n");
      out.write("        	$(function() {\r\n");
      out.write("        		\r\n");
      out.write("        		$(\"#ms-select>option\").each(function(){\r\n");
      out.write("        			\r\n");
      ...
      out.write("\" == \"recived\") {\r\n");
      out.write("        			\r\n");
      out.write("        			$(\"#status\").text(\"보낸 사람\");\r\n");
      out.write("        			\r\n");
      out.write("        		} else {\r\n");
      out.write("        			\r\n");
      out.write("        			$(\"#status\").text(\"받은 사람\");\r\n");
      out.write("        		}\r\n");
      out.write("        		\r\n");
      out.write("        	});\r\n");
      out.write("        	\r\n");
      out.write("        	$(function() {\r\n");
      out.write("        		\r\n");
      out.write("        		$(\".message-area>table>tbody>tr\").click(function() {\r\n");
      out.write("        			\r\n");
      out.write("        			// console.log(\"잘 클릭됬나..?\");\r\n");
      out.write("        			\r\n");
      out.write("        			// 클릭했을 때 자손요소 탐색을 통해\r\n");
      out.write("        			// 해당 게시글의 공지사항 번호를 추출해서 넘겨야 함\r\n");
      out.write("        			// => 해당 tr 요소의 자손 중에서 첫번째 td 영역의 내용이 필요\r\n");
      out.write("        			let dno = $(this).children().eq(0).text();\r\n");
      out.write("        			\r\n");
      out.write("        			// console.log(mno);\r\n");
      out.write("        			\r\n");
      out.write("        			// 요청할url주소?키=밸류&키=밸류&..\r\n");
      out.write("        			// ? 뒤의 내용들을 \"쿼리스트링\" 이라고 한다.\r\n");
      out.write("        			// get 방식의 경우 쿼리스트링이 노출되는 방식임!!\r\n");
      out.write("        			// location.href 속성으로 요청하면 get 방식임!!\r\n");
      out.write("        			// => 대놓고 쿼리스트링을 직접 만들어서 넘기기 가능\r\n");
      out.write("        					\r\n");
      out.write("        			location.href = \"");
      out.print( contextPath );
      out.write("/detail.mes?dno=\" + dno + \"&status=");
      out.print( status );
      out.write("\";\r\n");
      out.write("        			\r\n");
      out.write("        		});\r\n");
