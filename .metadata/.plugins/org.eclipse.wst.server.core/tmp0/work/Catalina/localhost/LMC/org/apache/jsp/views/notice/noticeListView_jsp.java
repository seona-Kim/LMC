 ...
 * Generated at: 2023-11-06 08:59:34 UTC
...
public final class noticeListView_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/views/notice/../common/menubar.jsp", Long.valueOf(1698080520456L));
    _jspx_dependants.put("/views/notice/../common/footer.jsp", Long.valueOf(1697763428000L));
  }
...
if(loginUser == null){ 
      ...
      out.write("                <i class=\"fas fa-exclamation-circle\"></i> 공지사항\r\n");
      out.write("            </h2>\r\n");
      out.write("            <br><br>\r\n");
 ...
 for(Notice n : list) { 
      ...
      out.write("			        	$(function(){\r\n");
      out.write("			        		$(\".table-area>.table>tbody>tr\").children().click(function() {\r\n");
      out.write("								let nno = $(this).parent().children().eq(0).text();\r\n");
