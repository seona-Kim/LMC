...
<body>
	...
	<%	// MemberSelectedController 의 request 로 부터 응답데이터 뽑기
		Member selectedM = (Member)request.getAttribute("selectedM");
	
		// slelectedM 에 담겨있는 회원정보 뽑기
		//	System.out.println(selectedM);
		
		int memberNo		=  selectedM.getMemberNo();
		String memberId 	=  selectedM.getMemberId();
		String memberName 	=  selectedM.getMemberName();
		String memberNick 	= (selectedM.getMemberNick() == null) 	? "" : selectedM.getMemberNick();
		String email 		= (selectedM.getEmail() == null) 	? "" : selectedM.getEmail();
		String enrollDate 	= (selectedM.getEnrollDate() == null) 	? "" : selectedM.getEnrollDate().toString();
		String memberImg 	= (selectedM.getMemberImg() == null) ? "/resources/images/pngwing.com.png" : selectedM.getMemberImg();
	...
	<div class="outer">
       ...
       <form id="mypage-form" action="<%= contextPath %>/changing.me" method="post" enctype="multipart/form-data">
           ...
           <table>
               ...
               <tr>
                   <td rowspan="2" colspan="2" align="right">
                       <img src="<%= contextPath %><%= memberImg %>" alt="" height="100px">
                   </td>
               ...
               <tr>
                   <td colspan="2" align="center">
                       <input type="file" name="updateImg" class="btn btn-secondary btn-sm" value="업로드">
                   </td>
               </tr>
           </table>
