...
/**
 * Servlet implementation class MessageEnrollFormController
 */
@WebServlet("/enrollForm.mes")
public class MessageEnrollFormController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public MessageEnrollFormController() {
        super();
...
//      MessageService 객체 생성해두기
		...
		RequestDispatcher view = request.getRequestDispatcher("views/message/messageEnrollForm.jsp");
