...
/**
 * Servlet implementation class AdminMemberStopController
 */
@WebServlet("/memberstoplist.me")
public class AdminMemberStopListController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminMemberStopListController() {
        super();
